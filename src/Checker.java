public class Checker extends Queen {
    ...
    public boolean chop(byte[][] field ,byte[] place_of_chop){
        if (Math.abs(place_of_chop[0]-position[0])==2
            ...
            position_of_chop[0] = (byte)((place_of_chop[0]-position[0])/2+position[0]);
            position_of_chop[1] = (byte)((place_of_chop[1]-position[1])/2+position[1]);
